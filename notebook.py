...
def _(wandb_traces_card):
    ...
    Enter your W&B API key and press **Connect** to use the **wandb** team.
    Choose a project below to organize this experiment. The connection is shared
    by direct planning and the code-writing agent. W&B Weave records model calls
    and Sandbox runs in that project.
    """),
        wandb_traces_card,
    ], align="start", widths=[0.72, 0.28], gap=1.5)
    return
...
def _():
    ...
    wandb_connect_form = (
        ...
        """)
        .batch(
            project=mo.ui.text(value="coreweave-hacks-can-llms-plan", full_width=True),
...
@app.cell(hide_code=True)
def wandb_tables_feature():
    # Official logo: https://site.wandb.ai/wp-content/uploads/2023/05/wb-cw.svg
    # Original icon and card styling: https://wandb.ai/site/inference/
    # Documentation: https://docs.wandb.ai/models/tables
    # Inline SVG keeps the icon available without fetching a remote image.
    wandb_tables_card = mo.Html(r"""<style>
    .cw-wb-tables-card {
      box-sizing: border-box; display: flex; flex-direction: column; align-items: center;
      gap: 10px; width: 180px; max-width: 100%; padding: 16px; margin-left: auto;
      background: #20242b; border: 1px solid #4b535c; border-radius: 8px;
    ...
    .cw-wb-tables-card:hover {transform: translateY(-4px); border-color: #ffcc33;}
    .cw-wb-tables-card:focus-visible {outline: 3px solid #ffcc33; outline-offset: 4px;}
    .cw-wb-tables-card svg {display: block; flex-shrink: 0;}
    .cw-wb-tables-card .cw-wb-brand {display:block; width:148px; max-width:100%; height:auto; margin:0 0 4px;}
    .cw-wb-tables-card .cw-wb-title {font-size: 20px; line-height: 26px; font-weight: 400;}
    .cw-wb-tables-card .cw-wb-description {font-size: 13px; line-height: 17px; color: #aeb3bd;}
    .cw-wb-tables-card .cw-wb-docs {font-size: 12px; line-height: 18px; color: #ffcc33; font-weight: 600;}
    @media (prefers-reduced-motion: reduce) {
      .cw-wb-tables-card {transition: none;}
    }
    </style>
    <a class="cw-wb-tables-card" href="https://docs.wandb.ai/models/tables"
       target="_blank" rel="noopener noreferrer" aria-label="W&B Tables documentation">
      <img class="cw-wb-brand" src="data:image/svg+xml;base64," width="148" height="29" alt="Weights &amp; Biases by CoreWeave">
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" aria-hidden="true" focusable="false" viewBox="0 0 73 73" fill="none"><rect x="0.382812" y="0.385254" width="72" height="72" rx="36" fill="#EDE8FF" fill-opacity="0.12"></rect><path d="M31.8451 24.6643C31.8451 24.5102 31.9682 24.3853 32.12 24.3853H40.6466C40.7984 24.3853 40.9215 24.5102 40.9215 24.6643V31.281C40.9215 31.4351 40.7984 31.56 40.6466 31.56H32.12C31.9682 31.56 31.8451 31.4351 31.8451 31.281V24.6643Z" fill="url(#cw-wb-tables-0)"></path><path d="M29.7547 31.56C29.9066 31.56 30.0297 31.4351 30.0297 31.281V24.6643C30.0297 24.5102 29.9098 24.3853 29.758 
offset="0.385417" stop-color="#FFCC33"></stop><stop offset="0.71875" stop-color="#FFAD33"></stop></linearGradient><linearGradient id="cw-wb-tables-4" x1="36.0684" y1="24.3853" x2="36.0684" y2="51.5395" gradientUnits="userSpaceOnUse"><stop offset="0.385417" stop-color="#FFCC33"></stop><stop offset="0.71875" stop-color="#FFAD33"></stop></linearGradient><linearGradient id="cw-wb-tables-5" x1="36.0684" y1="24.3853" x2="36.0684" y2="51.5395" gradientUnits="userSpaceOnUse"><stop offset="0.385417" stop-color="#FFCC33"></stop><stop offset="0.71875" stop-color="#FFAD33"></stop></linearGradient></defs></svg>
      <span class="cw-wb-title">Tables</span>
      <span class="cw-wb-description">Compare model results<br>and explore evaluations</span>
      <span class="cw-wb-docs">Read docs <span aria-hidden="true">↗</span></span>
    </a>""")
    return (wandb_tables_card,)


@app.cell(hide_code=True)
def evaluation_intro(wandb_tables_card):
    mo.hstack([
        mo.md("""
    ## Act 4 · Let the numbers settle it

    As the world grows, does each approach hold up? Compare four approaches:
    **plan without thinking**, **plan with thinking**, **write code**,
    and **code + verifier feedback**.

    **W&B Tables** keeps each plan alongside its outcome, timing, and token count.
    Compare the strategies below, then replay a run to see how the plan unfolds.
    """),
        wandb_tables_card,
    ], align="start", widths=[0.72, 0.28], gap=1.5)
    return
...
def evaluation_load(API_KEY, EVALUATION_ARTIFACT, EVALUATION_RUN_URL, load_evaluation):
    mo.stop(not API_KEY, mo.md("_Connect W&B above to load the results._"))
    try:
    ...
    mo.md(
        ...
        "**Experiment setup:** Gemma 4 31B with local inference, across three world seeds. "
        "Some grid/approach combinations have fewer records. "
...
def evaluation_takeaway(evaluation_df):
    ...
    Next, compare models and harness settings on the same worlds.
    """)
    return
...
@app.cell(hide_code=True)
def builders_inspiration():
    # Closing slide: allow about 30–45 seconds for the three examples.
    ...
    .cw-builders[role="region"] {
      box-sizing: border-box; container-type: inline-size;
      width: 100%; max-width: 1440px; margin: 8px auto 16px; padding: 24px;
      border: 1px solid #202623; border-radius: 10px;
      background: #fff; color: #202623; box-shadow: -6px 6px 0 #56b5a7;
      font-family: ui-sans-serif, system-ui, sans-serif; line-height: 1.4;
    }
    .cw-builders * {box-sizing: border-box;}
    .cw-builders .cw-builders-brand {
      display: flex; align-items: center; justify-content: space-between;
      flex-wrap: wrap; gap: 12px; color: #53615b; font-size: 13px;
    }
    ...
    @container (max-width: 560px) {
      .cw-builders .cw-builders-grid {grid-template-columns: 1fr;}
    }
    </style>
    <div class="cw-builders" role="region" aria-label="Inspiration for builders">
      <div class="cw-builders-brand">
        <img class="cw-builders-logo" src="https://marimo.io/logotype-wide.svg" alt="marimo" width="136" height="32">
